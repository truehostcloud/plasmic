...
import useSearch from '@plasmicpkgs/commerce/product/use-search'
import type {
  Product,
  SearchProductsHook,
} from '@plasmicpkgs/commerce/types/product'
import type { UseSearch } from '@plasmicpkgs/commerce/product/use-search'
